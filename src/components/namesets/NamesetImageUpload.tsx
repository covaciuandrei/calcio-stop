...
interface NamesetImageUploadProps {
  namesetId: string;
  onImageUploaded: (image: NamesetImage) => void;
  onError: (error: string) => void;
  onAllUploadsComplete?: () => void;
  disabled?: boolean;
}

const NamesetImageUpload: React.FC<NamesetImageUploadProps> = ({
  namesetId,
  onImageUploaded,
  onError,
  ...
  return (
    <div className="nameset-image-upload">
      <div
...
export default NamesetImageUpload;
